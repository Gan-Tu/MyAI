            ...
            <div className="pb-10 sm:pb-20 sm:pt-32 lg:py-20 lg:pt-20">
              <div className="relative">
                ...
                <h1 className="text-slate mt-14 text-pretty text-4xl/tight font-light">
                  Claims Extractor{" "}
                  <span className="text-green-500">by LLM</span>
                </h1>
                <p className="mt-4 text-sm/6 text-slate-700">
                  Claim Extractor is AI-powered factual claims breakdown tool.
                  Provide any text, and it instantly extracts individual factual
                  claims, in clear and concise sentences for analysis or review.
                </p>
