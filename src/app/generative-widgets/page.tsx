...
import GenerativeWidgets from "./generative-widgets";

export const metadata = {
  title: "Generative Widgets",
  description: "Generate and preview @tugan/widgets from a prompt.",
};
...
export default async function Page({
  ...
  return (
    <div className="flex place-content-center p-6">
      <GenerativeWidgets q={query} defaultModel={defaultModel} />
    </div>
  );
}
