...
export default function AiTopics({ q, defaultModel }: AiTopicsProps) {
  ...
  return (
    <div className="font-display mx-auto my-auto flex h-full w-full max-w-6xl grow flex-col pb-4 lg:flex-row dark:bg-gray-950">
            ...
            <div className="pb-10 sm:pt-32 sm:pb-20 lg:py-20 lg:pt-20">
              <div className="relative">
                ...
                >
                  ...
                  <div className="bg-slate/2.5 ring-slate/15 absolute inset-0 -z-10 rounded-lg ring-1 ring-sky-400/50 transition peer-focus:ring-sky-300" />
                </form>

                {/* Ideas */}
                <p className="my-4 line-clamp-3 gap-4 text-xs text-pretty text-slate-500">
      ...
      {(isLoading || card) && (
        <AiCard
          className="stretch no-scrollbar mx-auto max-h-screen w-full max-w-md min-w-[350px] grow pb-10 md:min-w-[400px] lg:mx-6 lg:w-1/2 lg:pt-32"
          card={card}
          hideHero={hideImage}
          images={images}
        />
